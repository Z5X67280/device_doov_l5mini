...
$(call inherit-product-if-exists, vendor/doov/l5mini/l5mini-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/doov/l5mini/overlay

ifeq ($(TARGET_PREBUILT_KERNEL),)
	LOCAL_KERNEL := device/doov/l5mini/prebuilt/zImage
else
	LOCAL_KERNEL := $(TARGET_PREBUILT_KERNEL)
endif

TARGET_OTA_ASSERT_DEVICE := L5M,l5mini,m2

TARGET_PROVIDES_INIT_RC := true

PRODUCT_COPY_FILES += \
	device/doov/l5mini/rootdir/init.rc:root/init.rc \
	device/doov/l5mini/rootdir/enableswap.sh:root/enableswap.sh \
	device/doov/l5mini/rootdir/init.mt6735.rc:root/init.mt6735.rc \
	device/doov/l5mini/rootdir/init.ssd.rc:root/init.ssd.rc \
	device/doov/l5mini/rootdir/init.xlog.rc:root/init.xlog.rc \
	device/doov/l5mini/rootdir/init.usb.rc:root/init.usb.rc \
	device/doov/l5mini/rootdir/init.mt6735.usb.rc:root/init.mt6735.usb.rc \
	device/doov/l5mini/rootdir/init.aee.rc:root/init.aee.rc \
	device/doov/l5mini/rootdir/init.project.rc:root/init.project.rc \
	device/doov/l5mini/rootdir/init.modem.rc:root/init.modem.rc \
	device/doov/l5mini/rootdir/init.trace.rc:root/init.trace.rc \
	device/doov/l5mini/rootdir/fstab.mt6735:root/fstab.mt6735 \
	device/doov/l5mini/rootdir/ueventd.rc:root/ueventd.rc \
	device/doov/l5mini/etc/media_codecs.xml:system/etc/media_codecs.xml \
	device/doov/l5mini/media_profiles.xml:system/etc/media_profiles.xml \
...
PRODUCT_COPY_FILES += \
    device/doov/l5mini/rootdir/etc/hostapd_default.conf:system/etc/hostapd/hostapd_default.conf \
...
# BT A2DP
PRODUCT_COPY_FILES += \
    vendor/doov/l5mini/proprietary/vendor/lib/hw/audio.a2dp.blueangel.so:system/vendor/lib/hw/audio.a2dp.mt6735.so
